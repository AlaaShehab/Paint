...
public class Rectangle extends Shapes implements Cloneable {
	...
	public void draw(Graphics canvas) {
		...
		g2.setColor(fillCol);
		g2.fillRect(pos.x, pos.y, prop.get("LENGTH").intValue(), prop.get("WIDTH").intValue());
		g2.setColor(col);
		g2.drawRect(pos.x, pos.y, prop.get("LENGTH").intValue(), prop.get("WIDTH").intValue());
	}
	...
	public boolean contains (Point last) {
		...
		y[0] = pos.y;
		y[2] = (int) (pos.y - prop.get("WIDTH"));
		y[1] = y[0];
		y[3] = y[2];
		return new Rectangle2D.Double(pos.x, pos.y, prop.get("LENGTH").intValue(), prop.get("WIDTH").intValue()).contains(last);
	}
